...
document.addEventListener('DOMContentLoaded', async () => {
    try {
        ...
        // --- NEU: Setze das globale "Alles OK"-Signal ---
        window.appReady = true;
        console.log("App erfolgreich initialisiert. Readiness-Signal gesetzt.");

    } catch (error) {
        console.error("Ein kritischer Fehler ist während der App-Initialisierung aufgetreten:", error);
        // Das window.appReady Signal wird nicht gesetzt, der Watchdog wird auslösen.
    }
