const DQ_ACHIEVEMENTS = {
    ...
    async renderAchievementsList() {
        ...
        // --- NEU: Robuste Prüfung und Initialisierung fehlender Achievements ---
        ...
        for (const key in DQ_DATA.achievements) {
            if (!char.achievements[key]) {
                ...
                charWasModified = true; // Markieren, dass eine Änderung stattgefunden hat
            }
        }

        // --- NEU: Charakter nur speichern, wenn er modifiziert wurde ---
        if (charWasModified) {
            ...
            // Warten, bis der Speichervorgang abgeschlossen ist
            ...
            card.innerHTML = `
                ...
                <div class="achievement-card-actions">
                    ...
                    <button class="action-button claim-button-small" data-action="claim" aria-label="Abholen" ${!ach.progress.claimable ? 'disabled' : ''}>
                        ${ach.status === 'completed' ? '✅' : claimText}
                    </button>
                </div>
            `;
        ...
        infoContainer.innerHTML = `
            ...
            <div class="achievement-details-box">
                ...
                <div class="detail-item">
                    ...
                    <span class="value">💰 ${rewardGold} ✨ ${rewardMana}</span>
                </div>
            </div>
    ...
    async claimReward(achievementKey) {
        ...
        const popupContent = `
            ...
            <p style="text-align: center; font-size: 1.2em; margin-top: 16px;">
                <strong>Belohnung:</strong> 💰 ${rewardGold} Gold & ✨ ${rewardMana} Mana
            </p>
        `;
