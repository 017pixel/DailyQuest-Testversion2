const DQ_EXTRA = {
    ...
    updateCountdown(quest) {
        ...
        const update = () => {
            ...
            if (remainingTime <= 0) {
                ...
                clearInterval(this.countdownInterval);
                // Die eigentliche Strafe wird durch die tägliche Prüfung beim App-Start gehandhabt
                return;
            }
    ...
    async completeExtraQuest() {
        ...
        if (new Date() > new Date(quest.deadline)) {
            ...
            // Gescheiterte Quest entfernen, die Strafe wird beim nächsten App-Start/Mitternacht verhängt.
