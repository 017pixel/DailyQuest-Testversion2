const DQ_EXERCISES = {
    ...
    handleFilterClick(event) {
        ...
        if (target.classList.contains('filter-button')) {
            // --- BUGFIX: Verhindert, dass der Such-Button als Filter behandelt wird ---
    ...
    openSearchPopup() {
        ...
        // --- BUGFIX: Info-Text manuell setzen, um Timing-Probleme zu vermeiden ---
    ...
    // --- BUGFIX: Komplette Neufassung der Suchlogik ---
    async executeSearch() {
        const input = DQ_UI.elements.searchExerciseInput;
        const errorMsg = DQ_UI.elements.searchExerciseError;
        ...
        try {
            ...
            if (foundExercise) {
                ...
                }, 100); // Eine kleine Verzögerung gibt dem DOM Zeit zum Rendern
