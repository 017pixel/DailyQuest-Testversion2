const DQ_STATS = {
    ...
    renderStats(char) {
        ...
        const statsToDisplay = [
            ...
            { key: 'ausdauer', name: 'Ausdauer' },
            { key: 'beweglichkeit', name: 'Beweglichkeit' },
            { key: 'durchhaltevermoegen', name: 'Durchhaltevermögen' },
            { key: 'willenskraft', name: 'Willenskraft' }
        ];
    ...
    createWeightChart(canvas, data, targetWeight) {
        ...
        if (data.length > 0) {
            ...
            const lastEntryX = getX(lastEntryIndex);
